...
/**
 * Test: Flunorette\Selections: Basic operations.
...
Assert::exception(function() use ($book) {
	$book->unknown_column;
}, 'Flunorette\UndeclaredColumnException', 'Cannot read an undeclared column \'unknown_column\'.');
...
Assert::exception(function() use ($book) {
	$book->test;
}, 'Flunorette\UndeclaredColumnException', 'Cannot read an undeclared column \'test\'.');
